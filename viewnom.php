...
$empid = $_SESSION['empid'];
	...
	$result = mysql_query("SELECT * FROM  employee, nominations where employee.empid = nominations.empid AND userstatus = 'active' AND nominations.sentby = '$empid' ORDER BY employee.fname ", $connection) or die(mysql_error());
...
<td><a href="editnom.php?id=<?php echo $row['nomid']?>&empid=<?php echo $row['empid']?>&sessid=<?php echo $_SESSION['sessid']; ?>">Edit</a></td>
