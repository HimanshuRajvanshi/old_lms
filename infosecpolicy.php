...
<div id="content">
    ...
    <div class="right_content">  <!-- Start of right content-->    
     ...
     <h2>Information Security Policy (Video)</h2>
   ...
   <div id="tabs">
   <!-- <ul>
  <li><a href="#tabs-1"> <h4>Information Security Policy</h4></a></li>
   

  </ul>-->
  <div id="tabs-1">
 <iframe width="420" height="315" src="http://www.youtube.com/embed/H7-tSluIYYs" frameborder="0" allowfullscreen></iframe>
  </div>
