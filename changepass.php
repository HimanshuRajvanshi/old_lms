...
$("#changepass").click(function()
{
	...
	var empid = $("#empid").val(); 	
	$.post("passwordproc.php",	{pass : pass,	empid : empid},	function(data)
	{
...
<label> Enter your password</label>       
       ...
       <input type="hidden" id="empid" value="<?php echo $_SESSION['empid']; ?>" />
        ...
        <button type="submit" class="positive" name="save" id="changepass"><img src="images/apply2.png" alt=""/>Submit</button>
