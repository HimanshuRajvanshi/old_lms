...
if($mess == 'exist')
  ...
  ?>
         <form action="process.php?action=apply" method="post" id="leaveform" onsubmit="return validateForm()">
         <div id="inputArea">
         <table width="100%" cellspacing="4" style="width:600px ; padding:10px" >
          <tr>
           ...
           <td width="237"><select name="halftype" id="halftype" style="display:none" > 
             ...
             <option value="First Half">10:00 am - 2:00 pm</option>
             <option value="Second Half">2:00 pm - 7:00 pm</option>
             </select>
...
<select name="fromtime" id="fromtime" style="display:none" > 
         ...
         <tr><td width="139">Start Date</td><td colspan="2"><input type="text" name="startdate" style="width:100px; display:inline" id="startdate"   />
           </td>
  </tr>
         <tr id="enddaterow">
           <td width="139">End Date</td>
           <td colspan="2"><input type="text" name="enddate" style="width:100px; display:inline" id="enddate" onchange=""  /></td>
           </tr>
         <tr id="totalrow">
           <td>Total Days</td>
           <td colspan="2">
